...
| 1 | `layer/02-api-consistency` | Tighten the API contract | Standard error shape, field-level validation details, pagination/filter/sort rules, request-id | `main` | stable | api-design | error model + contract cleanup | high — response contract breakage; mitigation: integration tests + Swagger alignment |
